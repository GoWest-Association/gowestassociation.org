...
if ( have_rows( 'icons' ) ) :
    ?>
    <div class="icons <?php print $icons_per_row ?> <?php print $theme ?>">
    <?php
    while ( have_rows( 'icons' ) ) : the_row();
        ...
        <a href="<?php print $link; ?>" class="icon <?php print $color . ' ' . $class; ?>">
            <?php if ( $theme == 'hexagons' ) : ?><div class="hexagon"></div><?php endif; ?>
            <div class="icon-image"><img src="<?php print $image; ?>" alt="<?php print $title_alt; ?>"></div>
            <h3><?php print $title; ?></h3>
            <?php if ( !empty( $button_text ) ) : ?><button class="btn navy"><?php print $button_text ?></button><?php endif; ?>
        </a>
        <?php endif; 
    endwhile;
    ?>
