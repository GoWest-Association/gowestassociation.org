...
<div class="two-column single-partner <?php print ( has_showcase() ? '' : ' no-showcase' ) ?>" role="main">
	<div class="sidebar">
		...
		<p class="partner-buttons"><?php print do_shortcode( '[button url="mailto:solutions@gowest.org" class="teal"]Email Us[/button] [button url="tel:8009959064" class="teal phone"]&#9743; 800.995.9064[/button]' ); ?></p>
